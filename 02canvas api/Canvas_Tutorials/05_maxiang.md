...
### 说明
马克飞象是一款很不错的在线markdown编辑器，还可以同步到evennote上面。这样自己就使用markdow来写对应的文档了的。

网址：

[马克飞象](http://maxiang.info/#)

自己可以在线编辑自己想要的文档，可以使用快捷键，可预览鞋面效果，同时可以同步到evennote上面。这是一个很方便的编辑器。

自己要话点时间来学习这个工具，在这以后自己的文档都都应该使用markdown来熟悉，使用马克飞象来生成对应的样式内容，使用gitbook来建立对应的各个文档之间的关系，自己可以通过，方便自己以后的使用和继续阅读。
