...
##  常用
##### step 1
新建readme.md和SUMMARY.md
在SUMMARY.md要指定在这个文档中应用的markdown文件
...
gitbook build 
```
*gitbook build * 构建起对应的gitbook，node会制动去索引SUMMARY.md中的markdown文件，然后生成相关的文件内容。
...
```
*gitbook serve  -p 8888 * 生成本地服务器，可以通过内容localhost访问。
